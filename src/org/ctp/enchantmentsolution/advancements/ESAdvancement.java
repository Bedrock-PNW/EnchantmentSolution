...
public enum ESAdvancement {
	...
	FOURTY_NINERS(BONEMEAL_PLUS, "GOLD_BLOCK", Arrays.asList(new ESTrigger("goldblock", 64)), 20),
	...
	POSEIDON_REBORN(POSEIDONS_DAY_OFF, "TRIDENT", Arrays.asList(new ESTrigger("heart_of_the_sea")), 200, Frame.CHALLENGE),
